                                    ...
                                    <div class="iphorm-container clearfix">
                                        ...
                                        <div class="contact_gauche">	
                                            <div class="element-wrapper name-element-wrapper clearfix">
                                                <label class="bold" for="nom" style="margin-right:222px;">Nom</label>
                                                <div class="input-wrapper name-input-wrapper">
                                                    <input class="name-element" id="nom" type="text" name="nom" style="width:250px;"/>
                                                </div>
                                            </div>
                                            <!-- Begin Phone element -->
                                            <div class="element-wrapper phone-element-wrapper clearfix">
                                                <label class="bold"  for="téléphone" style="margin-right:191px;">Téléphone</label>
                                                <div class="input-wrapper phone-input-wrapper">
                                                    <input class="phone-element" id="telephone" type="text" name="téléphone" style="width:250px;"/>
                                                </div>
                                            </div>
                                            <!-- Begin Email element -->
                                            <div class="element-wrapper email-element-wrapper clearfix">
                                                <label class="bold"  for="email" style="margin-right:159px;">Adresse courriel</label>
                                                <div class="input-wrapper email-input-wrapper">
                                                    <input class="email-element" id="email" type="text" name="email" style="width:250px;"/>
                                                </div>
                                            </div>
                                            <!-- End Email element -->
                                            <!-- Begin Message element -->
                                            <div class="element-wrapper message-element-wrapper clearfix" style="margin: -10px 0 10px 0px;">
                                                <p class="titre_contact" style="margin:14px 167px 1px 0px;">Votre message</p>
                                                <div class="input-wrapper message-input-wrapper clearfix">
                                                    <textarea style="width:250px;" class="message-element" id="message" name="message" rows="7" cols="25"></textarea>
                                                </div>
                                            </div>
                                            <!-- End Message element -->
